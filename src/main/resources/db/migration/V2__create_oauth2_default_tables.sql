...
(
    ...
    attributes                    TINYTEXT      NULL,
    state                         VARCHAR(500)  NULL,
    authorization_code_value      TINYTEXT      NULL,
    ...
    access_token_value            TINYTEXT      NULL,
    access_token_issued_at        datetime      NULL,
    access_token_expires_at       datetime      NULL,
    access_token_metadata         TINYTEXT      NULL,
    access_token_type             VARCHAR(255)  NULL,
    access_token_scopes           VARCHAR(1000) NULL,
    refresh_token_value           TINYTEXT      NULL,
    refresh_token_issued_at       datetime      NULL,
    refresh_token_expires_at      datetime      NULL,
    refresh_token_metadata        TINYTEXT      NULL,
    oidc_id_token_value           TINYTEXT      NULL,
    oidc_id_token_issued_at       datetime      NULL,
    oidc_id_token_expires_at      datetime      NULL,
    oidc_id_token_metadata        TINYTEXT      NULL,
    oidc_id_token_claims          TINYTEXT      NULL,
    user_code_value               TINYTEXT      NULL,
    user_code_issued_at           datetime      NULL,
    user_code_expires_at          datetime      NULL,
    user_code_metadata            TINYTEXT      NULL,
    device_code_value             TINYTEXT      NULL,
    device_code_issued_at         datetime      NULL,
    device_code_expires_at        datetime      NULL,
    device_code_metadata          TINYTEXT      NULL,
